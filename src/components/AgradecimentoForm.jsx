...
const AgradecimentoForm = ({ onBack }) => {
    ...
    const handleGeneratePDF = async () => {
        ...
        doc.save(`${new Date().toISOString().split('T')[0]}_Carta_Agradecimento_${donorData.codigo}.pdf`);
    };
                        ...
                        <div className="carta-preview-container">
                            <div className="carta-sheet">
                                ...
                                <div className="carta-content" style={{ marginTop: '8px' }}>
                                    ...
                                    <p style={{ textAlign: 'justify', margin: '0 0 10px 0', textIndent: '30px' }}>
                                        Doando-nos {description ? description.toLowerCase() : '________________________________________________'} como gesto de amor ao próximo.
                                    </p>
