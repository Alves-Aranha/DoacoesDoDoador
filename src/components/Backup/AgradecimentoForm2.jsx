...
const AgradecimentoForm2 = ({ onBack }) => {
    ...
    const handleGeneratePDF = () => {
        ...
        doc.save(`Carta_Agradecimento_2_${donorData.codigo}.pdf`);
                            ...
                            <div className="carta-sheet">
                                ...
                                <div className="carta-content" style={{ marginTop: '8px' }}>
                                    ...
                                    <p style={{ textAlign: 'justify', margin: '0 0 10px 0', textIndent: '30px' }}>
                                        Com nossos sinceros cumprimentos, agradecemos pela doação que nos fez de <strong>{description ? description.toLowerCase() : '________________________________________________'}</strong> como gesto de amor ao próximo.
                                    </p>
