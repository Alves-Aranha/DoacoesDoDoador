...
import FichaDoadorModal from './FichaDoadorModal';
...
const DonorForm = ({ onNavigateToDoacoes, onNavigateToAlterarDoacoes }) => {
    ...
    const [showFichaDoadorModal, setShowFichaDoadorModal] = useState(false);
    ...
    const handleSave = async (e) => {
        ...
        } catch (e) { showToast('Erro ao salvar.', 'error'); } finally { setLoading(false); }
    };
    ...
    return (
        <div className="main-content-layout" style={{ flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '10px', paddingLeft: '30px' }}>
                        ...
                        {isEditing ? (
                            ...
                            <>
                                ...
                                <button className="btn-action btn-secondary" style={{ flexShrink: 0 }} onClick={() => setShowFichaDoadorModal(true)} disabled={totalRecords === 0} title="Imprimir Ficha do Doador">
                                    <FileText size={18} />
                                </button>
                            </>
                        )}
            ...
            {showFichaDoadorModal && <FichaDoadorModal donor={formData} onClose={() => setShowFichaDoadorModal(false)} />}
