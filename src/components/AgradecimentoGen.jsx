...
const AgradecimentoGen = ({ onBack, data, onClose }) => {
    ...
    const printId = useMemo(function() {
        return 'print-agrad-gen-' + Math.random().toString(36).substr(2, 9);
    }, []);
    ...
    const handlePrint = function() {
        ...
        var printContent = document.querySelector('.' + printId + ' .carta-sheet').innerHTML;
        var styles = document.querySelector('.' + printId + ' style').innerHTML;
        ...
        doc.write(
            '<html>' +
                '<head>' +
                    ...
                    '<title>' + dateFolder + '_Carta_Agradecimento_' + (donorData.codigo || '') + '</title>' +
                    '<style>' +
                        styles +
                        '@media print {' +
        ...
        <div className={`main-content-layout carta-agrad-premium ${printId}`} style={{ flexDirection: 'column' }}>
            ...
            <div className="carta-card-premium no-print">
                <div className="carta-header-premium">
                    ...
                    <div>
                        <h2>Carta de Agradecimento Gen</h2>
                        ...
                        <div className="carta-preview-container">
                            <div className="carta-sheet">
                                ...
                                <div className="carta-content" style={{ marginTop: '8px' }}>
                                    ...
                                    <p style={{ textAlign: 'justify', margin: '0 0 10px 0', textIndent: '30px' }}>
                                        Entre os generosos corações dos que o fazem incluem-se os prezados Amigos, aos quais agradecemos pela
                                        doação que nos fez de {description ? description.toLowerCase() : '________________________________________________'}.
                                    </p>
                                    <p style={{ textAlign: 'justify', margin: '0 0 15px 0', textIndent: '30px' }}>
                                        Certo de que sempre poderemos contar com a sua efetiva colaboração, firmamo-nos, rogando a Deus os
                                        cubra de bênçãos e lhes propicie reiteradas oportunidades de progresso material e elevação espiritual.
                                    </p>
...
export default AgradecimentoGen;
